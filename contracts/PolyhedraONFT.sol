/**
 *Submitted for verification at PolygonScan.com on 2023-09-25
*/
...
/// @title Interface of DappGate, which follows the UniversalONFT standard
contract zkDappGate is ONFT721 {
    uint public mintFee = 0.037 ether;
    ...
    uint _startMintId,
    uint _endMintId) ONFT721("zkDappGate", "zkDapp", _minGasToTransfer, _layerZeroEndpoint) {
