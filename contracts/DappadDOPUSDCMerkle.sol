...
contract DappadLaunchpad is Ownable, Pausable {
    ...
    uint256 public totalUSDCReceivedInAllTier;
    ...
    if (hasNFT(msg.sender)) {
        ...
        totalUSDCReceivedInAllTier = totalUSDCReceivedInAllTier.add(amount);
        ...
        require(
            totalUSDCReceivedInAllTier.add(amount) <= maxCap,
    ...
    modifier _hasAllowance(address allower, uint256 amount) {
        ...
        // Function to check if a user has the required ONFT
    function hasNFT(address _user) internal view returns (bool) {
