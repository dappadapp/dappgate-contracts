...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function transferFrom(address from, address to, uint256 tokenId) public virtual override {
        ...
        require(isTransferable, "Solbound NFT");
...
contract Pass is ONFT721 {
    using Strings for uint256;

    uint public mintFee = 0.001529 ether;
    uint public bridgeFee = 0.006 ether;
    ...
    uint _startMintId,
    uint _endMintId) ONFT721("DappGate Tracker Pass by DappLabs", "DGPASS", _minGasToTransfer, _layerZeroEndpoint) {
        nextMintId = _startMintId;
        maxMintId = _endMintId;
        baseTokenURI = "https://trc.zkl.app/";
        moderatorAddress = 0x3772f434d796A1B974E9B2cD37055a075F3450be;
    }


    function setTransfer(bool _isTransfer) public onlyOwner {
        isTransferable = _isTransfer;
    }
