...
contract DappGate is OFT {
    uint public mintFee = 0.00033 ether; // fee per token
    uint public bridgeFee = 0.000054 ether;
    ...
    function sendFrom(address _from, uint16 _dstChainId, bytes calldata _toAddress, uint _amount, address payable _refundAddress, address _zroPaymentAddress, bytes calldata _adapterParams) public payable virtual override(OFTCore) {
