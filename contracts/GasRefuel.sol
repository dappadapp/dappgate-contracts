...
contract DappgateGasRefuel is NonblockingLzApp {
    using BytesLib for bytes;
    ...
    function bridgeGas(uint16 _dstChainId, bytes memory _toAddress, bytes memory _adapterParams, uint16 _pkType, uint _extraGas) public payable virtual {
        _checkAdapterParams(_dstChainId, _pkType, _adapterParams, _extraGas);
