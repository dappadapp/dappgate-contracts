...
export interface DappadFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadFactory extends BaseContract {
  connect(runner?: ContractRunner | null): DappadFactory;
  waitForDeployment(): Promise<this>;

  interface: DappadFactoryInterface;
