...
export interface DappadVestingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    ...
    values: [IDappadVesting.VestingAddressesStruct]
  ): string;
  encodeFunctionData(
...
export interface DappadVesting extends BaseContract {
  connect(runner?: ContractRunner | null): DappadVesting;
  waitForDeployment(): Promise<this>;

  interface: DappadVestingInterface;
  ...
  saleContract: TypedContractMethod<[], [string], "view">;
