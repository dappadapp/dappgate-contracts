...
export interface DappadSaleONFTHoldersInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadSaleONFTHolders extends BaseContract {
  connect(runner?: ContractRunner | null): DappadSaleONFTHolders;
  waitForDeployment(): Promise<this>;

  interface: DappadSaleONFTHoldersInterface;
