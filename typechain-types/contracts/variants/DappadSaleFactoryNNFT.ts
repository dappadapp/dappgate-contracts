...
export interface DappadSaleFactoryNNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadSaleFactoryNNFT extends BaseContract {
  connect(runner?: ContractRunner | null): DappadSaleFactoryNNFT;
  waitForDeployment(): Promise<this>;

  interface: DappadSaleFactoryNNFTInterface;
