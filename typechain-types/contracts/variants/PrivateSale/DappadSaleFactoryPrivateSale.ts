...
export interface DappadSaleFactoryPrivateSaleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadSaleFactoryPrivateSale extends BaseContract {
  connect(runner?: ContractRunner | null): DappadSaleFactoryPrivateSale;
  waitForDeployment(): Promise<this>;

  interface: DappadSaleFactoryPrivateSaleInterface;
  ...
  filters: {
    ...
    "SaleCreated(string,uint256,uint256,uint256,address,address)": TypedContractEvent<
      SaleCreatedEvent.InputTuple,
      SaleCreatedEvent.OutputTuple,
      SaleCreatedEvent.OutputObject
    >;
