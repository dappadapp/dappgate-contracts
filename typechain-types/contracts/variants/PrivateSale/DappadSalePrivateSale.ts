...
export interface DappadSalePrivateSaleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadSalePrivateSale extends BaseContract {
  connect(runner?: ContractRunner | null): DappadSalePrivateSale;
  waitForDeployment(): Promise<this>;

  interface: DappadSalePrivateSaleInterface;
