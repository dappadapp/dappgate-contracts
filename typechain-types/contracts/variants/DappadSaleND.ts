...
export interface DappadSaleNDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadSaleND extends BaseContract {
  connect(runner?: ContractRunner | null): DappadSaleND;
  waitForDeployment(): Promise<this>;

  interface: DappadSaleNDInterface;
