...
export interface DappadSaleNInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadSaleN extends BaseContract {
  connect(runner?: ContractRunner | null): DappadSaleN;
  waitForDeployment(): Promise<this>;

  interface: DappadSaleNInterface;
