...
export interface DappadSaleFactoryNInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadSaleFactoryN extends BaseContract {
  connect(runner?: ContractRunner | null): DappadSaleFactoryN;
  waitForDeployment(): Promise<this>;

  interface: DappadSaleFactoryNInterface;
