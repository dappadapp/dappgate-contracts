...
export interface DappadFactoryNNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadFactoryNNFT extends BaseContract {
  connect(runner?: ContractRunner | null): DappadFactoryNNFT;
  waitForDeployment(): Promise<this>;

  interface: DappadFactoryNNFTInterface;
