...
export interface DappadPublicSaleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadPublicSale extends BaseContract {
  connect(runner?: ContractRunner | null): DappadPublicSale;
  waitForDeployment(): Promise<this>;

  interface: DappadPublicSaleInterface;
