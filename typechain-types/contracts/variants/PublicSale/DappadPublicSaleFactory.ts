...
export interface DappadPublicSaleFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadPublicSaleFactory extends BaseContract {
  connect(runner?: ContractRunner | null): DappadPublicSaleFactory;
  waitForDeployment(): Promise<this>;

  interface: DappadPublicSaleFactoryInterface;
