...
export interface DappadFactoryNInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN"
      | "DEFAULT_ADMIN_ROLE"
...
export interface DappadFactoryN extends BaseContract {
  connect(runner?: ContractRunner | null): DappadFactoryN;
  waitForDeployment(): Promise<this>;

  interface: DappadFactoryNInterface;
